                                            ...
                                            <div className="cart__item">
                                                <div className="cart__book">
                                                    ...
                                                    <div className="cart__book--info">
                                                        ...
                                                        <button className="cart__book--remove" onClick={() => removeItemFromCart(book)}>
                                                            Remove
                                                        </button>
                                                    </div>
                                                </div>
                                                <div className="cart__quantity">
                                                    <input type="number" min={1} max={99} className="cart__input"
                                                        value={book.quantity}
                                                        onChange={(event) => changeCartItemQuantity(book, event.target.value)} />
                                                </div>
